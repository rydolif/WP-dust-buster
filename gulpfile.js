...
gulp.task('js', function() {
	return gulp.src([
		...
		'local/assets/libs/twentytwenty/jquery.twentytwenty.js', 				//----twentytwenty
		'local/assets/libs/twentytwenty/jquery.event.move.js', 				//----twentytwenty
		'local/assets/libs/jquery.spincrement.min.js', 				//----twentytwenty
